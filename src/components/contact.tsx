      ...
      <div className="flex flex-row gap-8  flex-wrap justify-center">
        ...
        >
          <Image
            ...
            height={25}
          />
          <p className="hover:underline">/nishant-pradhan8</p>
        </a>
        <a
          target="_blank"
          ...
          className="font-sans flex flex-row gap-2 cursor-pointer items-center "
        >
          <Image src="/images/email.svg" alt="email" width={25} height={25} />
          <p className="hover:underline">nishant.pradhan0520@gmail.com</p>
        </a>
        <a
          target="_blank"
        ...
        >
          <Image
            ...
            height={25}
          />
          <p className="hover:underline">+977 9819180805</p>
        </a>
      </div>
    </div>
  );
